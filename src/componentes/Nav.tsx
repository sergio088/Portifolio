export default function Nav() {
  return (
    <nav className="flex flex-col space-y-3 lg:flex-row ">
      <a href="https://github.com/sergio088" className="flex space-x-2">
        ...
        <span className="text-slate-500 lg:hidden ">Git Hub</span>
      </a>
      <a
      ...
      >
        ...
        <span className="text-slate-500 lg:hidden ">Linkedin</span>
      </a>
    </nav>
  );
}
